...
Stack				*check_rev_rotation_both(Stack *a, Stack *b,
						Stack *cheapest);
...
Stack				*b_to_a_both_above(Stack *a, Stack *b, Stack *cheapest);
Stack				*b_to_a_both_below(Stack *a, Stack *b, Stack *cheapest);
Stack				*b_below_to_a(Stack *a, Stack *b, Stack *cheapest);
Stack				*b_above_to_a(Stack *a, Stack *b, Stack *cheapest);
Stack    			*begin_sort_b(Stack *a, Stack *b);
